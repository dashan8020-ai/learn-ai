...
- **[AINews] Anthropic @ $30B ARR, Project GlassWing and Claude Mythos Preview — first model too dangerous to release since GPT-2** — Anthropic steps up the offensive vs OpenAI's upcoming IPO woes  
